...
from django.shortcuts import render, redirect
from .models import Product, CartItem, Member, checkoutitem, forcontact,userorder
...
# def order(request):
#     orderitems = CartItem.objects.all()
#     return redirect(request, 'checkout.html', {'orderitems': orderitems })
